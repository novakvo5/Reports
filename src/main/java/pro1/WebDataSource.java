...
public abstract class WebDataSource implements DataSource {
    ...
    public String getTerminyZkousek2(String katedra) {
        var uri = String.format(
                "https://stag-demo.uhk.cz/ws/services/rest2/terminy/getTerminyZkousek?outputFormat=JSON&katedra=%s",
                katedra);
        return getFromUri(uri);
    }
}
